  ...
  const checkToken = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${process.env.REACT_APP_BASEURL}/user/checkToken`,
        JSON.stringify({ JWTToken: authToken })
      );
        ...
        >
          <Router>
            ...
            <Switch>
              ...
              <Redirect
                from="/edit"
                to={`/${userType === 0 ? "page" : "organization"}?id=${userID}`}
              />
              ...
              <Route
                path="/profile"
                component={() => <ProfilePage userID={userID} />}
              />
