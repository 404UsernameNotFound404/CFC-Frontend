...
function LearnPage(props: any) {
  const issues = [
      { Links: [{name: "David Suzuki Foundation", link: "https://davidsuzuki.org/"}, {name: "World Wide Fund for Nature", link: "https://www.worldwildlife.org/"}], Color: "#4aa84e", ImageUrl: EnvormentImage, Title: "Climate Change", SubTitle: "The Future Of Our Planet", Para: "We are in the midst of a climate crisis, and the effects are being felt across the world. We would recommend checking out the David Suzuki Foundation and the World Wildlife Fund to learn more."},
      ...
      { Links: [{name: "First Nations Family Caring Society", link: "https://fncaringsociety.com/"}, {name: "Canadian Civil Liberties Association", link: "https://ccla.org/"}], Color: "purple", ImageUrl: RacialJustice, Title: "Racial Justice", SubTitle: "Equal Rights For Ever Race", Para: "Racism is unfortunately alive and well all across the world. We know that we are stronger together, regardless of our racial and cultural backgrounds. Here are some links to learn more."},
      { Links: [{name: "Egale Canada Human Rights Trust", link: "https://egale.ca/"}, {name: "PFLAG Canada", link: "https://pflagcanada.ca/"}], Color: "#3c78d8", ImageUrl: LGBTQ, Title: "LGBTQ Equality", SubTitle: "Equal Rights For Ever Sexual And Gender Identity", Para: "LGBTQ people in Canada and around the world still face harassement and discrimination because of who they are. This can affect everything from access to healthcare services, to difficulty finding employment."},
  ]
  return (
    <Page>
